                    ...
                    <div class="header__navbar">
                        <ul class="list-unstyled">
                            <li class="@yield('dashboard_select')">
                                <a href="{{url('/counter/dashboard')}}">
                                    <i class="fas fa-tachometer-alt"></i>
                                    <span fas fa-tachometer-alt></span>Dashboard</a>
                            </li>
                            <li class="has-sub @yield('category_select') @yield('item_select') @yield('vat_select')">
                                <a href="#">
                                    <i class="fas fa-copy"></i>
                                    <span class="bot-line"></span>Manage Items</a>
                                <ul class="header3-sub-list list-unstyled">
                                    <li class="@yield('category_select')">
                                        <a href="{{url('/counter/category')}}">
                                            <i class="fas fa-shopping-basket"></i>
                                            <span class="bot-line"></span>Category</a>
                                    </li>
                                    <li class="@yield('size_select')">
                                        <a href="{{url('/counter/size')}}">
                                            <i class="fas fa-shopping-basket"></i>
                                            <span class="bot-line"></span>Size</a>
                                    </li>
                                    <li class="@yield('type_select')">
                                        <a href="{{url('/counter/type')}}">
                                            <i class="fas fa-shopping-basket"></i>
                                            <span class="bot-line"></span>Type</a>
                                    </li>
                                    <li class="@yield('item_select')">
                                        <a href="{{url('/counter/item')}}">
                                            <i class="fas fa-shopping-basket"></i>
                                            <span class="bot-line"></span>Items</a>
                                    </li>
                                    <li class="@yield('vat_select')">
                                        <a href="{{url('/counter/vat')}}">
                                            <i class="fas fa-shopping-basket"></i>
                                            <span class="bot-line"></span>VAT</a>
                                    </li>
                                    <li class="@yield('table_select')">
                                        <a href="{{url('/counter/table')}}">
                                            <i class="fas fa-shopping-basket"></i>
                                            <span class="bot-line"></span>Table</a>
                                    </li>
                                    <li class="@yield('waiter_select')">
                                        <a href="{{url('/counter/waiter')}}">
                                            <i class="fas fa-shopping-basket"></i>
                                            <span class="bot-line"></span>Waiter</a>
                                    </li>
                                    <li class="@yield('coupon_select')">
                                        <a href="{{url('/counter/coupon')}}">
                                            <i class="fas fa-shopping-basket"></i>
                                            <span class="bot-line"></span>Coupon</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="has-sub">
                                ...
                                <ul class="header3-sub-list list-unstyled">
                                    <li class="@yield('collect_order_select')">
                                        <a href="{{url('/counter/collect_order')}}">
                                            <i class="fas fa-shopping-basket"></i>
                                            <span class="bot-line"></span>Collect Order</a>
                                    </li> 
                                    <li class="@yield('totalorder_select')">
                                        <a href="{{url('/counter/totalorder')}}">
                                            <i class="fas fa-shopping-basket"></i>
            ...
            <div class="header-mobile__bar">
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="{{url('/counter/dashboard')}}">
                            <img src="{{asset('assets/images/icon/logo.png')}}" alt="RedSoft" />
                        </a>
                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-copy"></i>Manage Items</a>
            ...
            <section class="p-t-60">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="copyright">
                                <p>Copyright © 2021 Red Soft. All rights reserved.</p>
                            </div>
                        </div>
                    </div>
                </div>
